    ...
    <div class="articles articles__vertical">
      ...
      while($comment = mysqli_fetch_assoc($comments)){
        ...
        <article class="article">
          <div class="article__image"
               style="background-image: url(https://www.gravatar.com/avatar/<?php md5( $comment['email'] );?>?s=125);"></div>
          <div class="article__info">
      ...
      <article class="article">
        ...
        <div class="article__info">
          ...
          <div class="article__info__preview">Бла бла бла бла бла бла бла, и
            думаю еще что бла бла бла бла бла бла бла ...
          </div>
        </div>
      </article>
