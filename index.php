    ...
    <div class="container">
      <div class="row">
        <section class="content__left col-md-8">
                    ...
                    <article class="article">
                      ...
                      <div class="article__info">
                        ...
                        <div class="article__info__meta">
                          ...
                          ?>
                          <small>Категория: <a href="/articles.php?category=<?php echo $art_cat['id']; ?>"><?php echo $art_cat['title']; ?></a>
                          </small>
                        </div>
          ...
          <div class="block">
            <a href="/articles.php?category=7">Все записи</a>
            <h3>Кулинария</h3>
            <div class="block__content">
              <div class="articles articles__horizontal">
                ...
                while($art = mysqli_fetch_assoc($articles)){
                  ...
                  <article class="article">
                    ...
                    <div class="article__info">
                      <a
                        href="/articles.php?id=<?php echo $art['id']; ?>"><?php echo $art['title'] ?></a>
                      <div class="article__info__meta">
                        <?php
                        $art_cat = FALSE;
                        foreach ($categories as $cat) {
                        ...
                        ?>
                        <small>Категория: <a
                            href="/articles.php?category=<?php echo $art_cat['id']; ?>"><?php echo $art_cat['title']; ?></a>
                        </small>
                      </div>
                      <div
                        class="article__info__preview"><?php echo mb_substr(strip_tags($art['text']), 0, 100, 'utf-8') . ' ...'; ?></div>
                    </div>
                  </article>
                <?php } ?>
          ...
          <div class="block">
            <a href="/article.php?category=2">Все записи</a>
